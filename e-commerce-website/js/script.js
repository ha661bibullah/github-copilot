...
function removeFromCart(itemId, color, size) {
...
function updateCartItem(itemId, color, size, quantity) {
    let cart = getCartItems();
...
function displayProducts(products, containerId) {
    ...
    products.forEach(product => {
        ...
        if (container.classList.contains('products-list')) {
            ...
            productCard.querySelector('.btn-outline').addEventListener('click', function() {
    ...
    return [
        {
            ...
            description: 'These premium wireless headphones feature active noise cancellation, 30-hour battery life, and crystal-clear sound quality. Perfect for music lovers and frequent travelers.',
        ...
        },
        {
            ...
            description: 'Stay connected and monitor your health with this feature-packed smartwatch. Includes heart rate monitoring, GPS, water resistance, and 7-day battery life.',
        ...
        },
        {
            ...
            description: 'These lightweight running shoes feature advanced cushioning technology for maximum comfort during your runs. Breathable mesh upper provides excellent ventilation.',
        ...
        },
        {
            ...
            description: 'Take your music anywhere with this portable Bluetooth speaker. Features 20-hour battery life, waterproof design, and powerful sound in a compact package.',
        ...
        },
        {
            ...
            description: 'This durable backpack features a padded laptop compartment, multiple pockets for organization, and comfortable shoulder straps. Perfect for work or travel.',
        ...
        },
        {
            ...
            description: 'Monitor your steps, calories burned, sleep patterns, and more with this advanced fitness tracker. Water-resistant design and 10-day battery life.',
        ...
        },
        {
            ...
            description: 'This classic denim jacket features a timeless design suitable for both men and women. Made from high-quality denim for durability and comfort.',
        ...
        },
        {
            ...
            description: 'Wake up to freshly brewed coffee with this programmable coffee maker. Features a thermal carafe to keep coffee hot for hours and a 24-hour programmable timer.',
...
function updateCartCount() {
    ...
    if (token) {
        // For logged in users, we'd ideally fetch from API
